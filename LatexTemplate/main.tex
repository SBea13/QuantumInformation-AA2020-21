...
\author{Beatrice Segalini} % Student name

\date{October 20th, 2020} % Due date

\institute{University of Padua \\ Physics and Astronomy Department} % Institute or school name

\class{Quantum Information and Computing 2020} % Course or class name

\professor{S. Montangero} % Professor or teacher in charge of the assignment
